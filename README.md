...
[![Test](https://github.com/sura/PHP-FFMpeg/actions/workflows/test.yaml/badge.svg)](https://github.com/Sura/PHP-FFMpeg/actions/workflows/test.yaml)

An Object-Oriented library to convert video/audio files with FFmpeg / AVConv.

Check another amazing repo: [PHP FFMpeg extras](https://github.com/sura/PHP-FFMpeg-Extras), you will find lots of Audio/Video formats there.
...
```bash
$ composer require sura/php-ffmpeg
```
